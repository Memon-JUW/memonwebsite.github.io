...
<nav class="navbar navbar-expand-sm " id="ho" style="background-color:rgb(21,32,75);">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" id="O" style="color:rgb(159,255,255);margin-left: 10px;margin-top: 10px;" href="view.php">View</a>
    </li>
    <li class="nav-item">
...
while($row= $r->fetch_assoc()){
	echo"<tr><td style='border:2px solid black;'>".$row["Id"]."</td><td style='border:2px solid black;'>".$row["Username"]."</td><td style='border:2px solid black;'>".$row["Email"]."</td><td style='border:2px solid black;'>".$row["Password"]."</td><td style='border:2px solid black;'>".$row["Faculty"]."</td><td style='border:2px solid black;'>".$row["Batch"]."</td><td style='border:2px solid black;'>".$row["Source"]."</td><td style='border:2px solid black;'>".$row["Area"]."</td></tr>";
}
echo "</table>";
}
else{
