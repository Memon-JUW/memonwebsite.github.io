...
<nav class="navbar navbar-expand-sm" id="ho" style="background-color:rgb(21,32,75);">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" style="color:rgb(159,255,255);margin-left: 10px;margin-top: 10px;" id="O" href="de.php">Delete</a>
    </li>
    <li class="nav-item">
...
while($row= $r->fetch_assoc()){
	echo"<tr><td style='border:2px solid black;font-weight:700;'>".$row["Id"]."</td><td style='border:2px solid black;font-weight:700;'>".$row["Username"]."</td><td style='border:2px solid black;font-weight:700;'>".$row["Email"]."</td><td style='border:2px solid black;font-weight:700;'>".$row["Password"]."</td><td style='border:2px solid black;font-weight:700;'>".$row["Faculty"]."</td><td style='border:2px solid black; font-weight:700;'>".$row["Batch"]."</td><td style='border:2px solid black; font-weight:700;'>".$row["Source"]."</td><td style='border:2px solid black; font-weight:700;'>".$row["Area"]."</td><td style='border:2px solid black; font-weight:700;'><a href='delete.php? i=$row[Id]  & un=$row[Username] & em=$row[Email] & ps=$row[Password] & ft=$row[Faculty] & b=$row[Batch] & sr=$row[Source] & ar=$row[Area]'>Delete</a></td></tr>";
}
echo "</table>";
}
else{
