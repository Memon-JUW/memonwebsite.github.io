		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				<div class="row" style="margin-top:-350px;">
					...
					<div class="col-md-12 right-header" style="margin-top:-8px;">
				...
				<div class="row">
					<div class="col-md-12 right-chat-textbox" id="d">
						...
						<button class="btn-info" name="submit" id="bt" onclick="loadDoc()" style="width:6%; border:1px solid black;"> Send</button>
						</form>
					</div>
				</div>
			</div>
