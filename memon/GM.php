...
<nav class="navbar navbar-expand-sm" id="ho" style="background-color:rgb(21,32,75);">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" style="color:rgb(159,255,255);margin-left: 10px;margin-top: 10px;" id="O"  href="GM.php">View Graph</a>
    </li>
    <?php
session_start();
if (isset($_SESSION['E'])){
...
<html>
  ...
  <head>
    ...
    ?>
        ...
        var options = {
          chart: {
            title: 'JINNAH UNIVERSITY LOCATION CHART',
            subtitle: 'BATCH, AREA',
          }
        };
    ...
    <div id="columnchart_material" style="width: 100%; height: 500px; border:2px solid rgb(21,32,75);"></div>
